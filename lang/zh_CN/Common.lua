CommonTranslationTable = {
	...
	["spade_char"]="<img src='image/system/log/spade.png' height=12/>",
	["club_char"]="<img src='image/system/log/club.png' height=12/>",
	["heart_char"]="<img src='image/system/log/heart.png' height=12/>",
	["diamond_char"]="<img src='image/system/log/diamond.png' height=12/>",
	["no_suit_char"] = "无色",
	["start"] = "开始",
	["judge"] = "判定",
	["retrial"] = "改判",
