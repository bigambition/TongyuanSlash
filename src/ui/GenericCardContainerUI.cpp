...
void PlayerCardContainer::repaintAll() {
	...
	/*if (_m_shenmiAnimation != NULL)
		startShenmi(_m_shenmiGeneralName, _m_shenmiSkillName);*/
...
//void PlayerCardContainer::startShenmi(QString generalName, QString skillName) {
//	_m_shenmiGeneralName = generalName;
//	_m_shenmiSkillName = skillName;
//	Q_ASSERT(m_player->hasSkill("shenmi"));
//
//	bool second_haibo = m_player && m_player->getGeneralName() != "haibo" && m_player->getGeneral2Name() == "haibo";
//	int avatarSize = second_haibo ? _m_layout->m_smallAvatarSize :
//		(m_player->getGeneral2() ? _m_layout->m_primaryAvatarSize :
//		_m_layout->m_avatarSize);
//	QPixmap pixmap = G_ROOM_SKIN.getGeneralPixmap(generalName, (QSanRoomSkin::GeneralIconSize)avatarSize);
//
//	QRect animRect = second_haibo ? _m_layout->m_smallAvatarArea : _m_layout->m_avatarArea;
//	if (pixmap.size() != animRect.size())
//		pixmap = pixmap.scaled(animRect.size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
//	if (second_haibo)
//		pixmap = paintByMask(pixmap);
//
//	stopShenmi();
//	_m_shenmiAnimation = G_ROOM_SKIN.createShenmiAnimation(pixmap, animRect.topLeft(), _getAvatarParent(), _m_shenmiItem);
//	_m_shenmiAnimation->start();
//	_paintPixmap(_m_extraSkillBg, _m_layout->m_extraSkillArea, QSanRoomSkin::S_SKIN_KEY_EXTRA_SKILL_BG, _getAvatarParent());
//	//_m_extraSkillBg->show();
//	//_m_layout->m_extraSkillFont.paintText(_m_extraSkillText, _m_layout->m_extraSkillTextArea, Qt::AlignCenter,
//	//	Sanguosha->translate(skillName).left(2));
...
//}
//
//void PlayerCardContainer::stopShenmi() {
//	if (_m_shenmiAnimation != NULL) {
//		_m_shenmiAnimation->stop();
//		_m_shenmiAnimation->deleteLater();
//		delete _m_shenmiItem;
//		_m_shenmiAnimation = NULL;
//		_m_shenmiItem = NULL;
//		_clearPixmap(_m_extraSkillBg);
//		_clearPixmap(_m_extraSkillText);
//	}
