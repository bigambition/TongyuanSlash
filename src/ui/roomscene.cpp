...
void RoomScene::handleGameEvent(const Json::Value &arg) {
    ...
    case S_GAME_EVENT_HUASHEN: {
            ...
            break;
							   ...
							   /*case S_GAME_EVENT_SHENMI: {
							   ClientPlayer *player = ClientInstance->getPlayer(arg[1].asCString());
							   QString shenmiGeneral = arg[2].asCString();
							   QString shenmiSkill = arg[3].asCString();
							   PlayerCardContainer *container = (PlayerCardContainer *)_getGenericCardContainer(Player::PlaceHand, player);
							   container->startShenmi(shenmiGeneral, shenmiSkill);
							   break;
							   }*/
    ...
    case S_GAME_EVENT_DETACH_SKILL: {
			...
			/*if(!player->hasSkill("shenmi"))
				container->stopShenmi();*/
            break;
        }
...
void RoomScene::doAnimation(int name, const QStringList &args) {
    ...
    if (map.isEmpty()) {
		...
		//map[S_ANIMATE_SHENMI] = &RoomScene::doShenmi;
    ...
    if (anim_name.isEmpty()) {
		...
		//anim_name[S_ANIMATE_SHENMI] = "shenmi";
