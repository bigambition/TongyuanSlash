...
public:
	...
	/*virtual void startShenmi(QString generalName, QString skillName);
	virtual void stopShenmi();*/
...
protected:
	...
	/*QAbstractAnimation *_m_shenmiAnimation;
	QGraphicsItem *_m_shenmiItem;
	QString _m_shenmiGeneralName;
	QString _m_shenmiSkillName;*/
